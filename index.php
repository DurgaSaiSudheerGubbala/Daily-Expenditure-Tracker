...
<head>
	...
	<title>Daily Expenditure Tracker - Login</title>
...
<body>
	...
	<div class="row">
			<h2 align="center">Daily Expenditure Tracker Login</h2>
	<hr />
    ...
    echo $msg;
					...
					<form role="form" action="" method="post" id="" name="login">
						<fieldset>
							...
							<a href="forgot-password.php">Forgot Password?</a><a href="register.php">||Register </a>
							<div class="form-group">
